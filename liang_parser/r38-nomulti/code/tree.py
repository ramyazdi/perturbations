...
'''A PTB style tree for reranking
   ...
   Be careful when you translate Johnson liang_parser into Python!

   Also note that my liang_parser can automatically remove empty nodes (*NONE*) and traces (NP-1) and stuff...
'''
...
## attached liang_parser does empty node removal ##

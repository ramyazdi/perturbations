...
from neuro_nlp.nlinalg import logsumexp, logdet
...
class ChainCRF(nn.Module):
    ...
    def loss(self, energy, target, mask=None):
        '''
    ...
    def decode(self, energy, leading_symbolic=0):
        """
